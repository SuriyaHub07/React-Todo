...
const Landingpages = () => {
  return (
    <div className='bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 min-h-screen'>
        {/* Navbar */}
        ...
        <section className='text-center py-20 '>
            ...
            <p className='text-sm text-white px-25 tracking-tighter mt-1'>Organize your life with our powerful and easy-to-use Todo App</p>
            <div className='mt-5'>
      ...
      <section className='py-16 bg-gradient-to-r from-purple-600 to-blue-600 text-center'>
          <div >
            ...
            <p className='text-sm text-grey-600 mt-4 px-70'>Todo master is designed to make your daily task management as easy 
